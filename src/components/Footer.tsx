...
import { Layers, Github, FileText, Mail, ArrowUp } from 'lucide-react';
...
export default function Footer({ onNavigate }: FooterProps) {
  ...
  return (
    <footer className="w-full bg-[#020617] border-t border-white/10 pt-16 pb-12 px-4 md:px-8 text-left relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mb-12">
          ...
          {/* Brand Col (5 Cols for more breathing room) */}
          ...
          <div className="md:col-span-7 grid grid-cols-2 gap-8 sm:gap-12 font-sans justify-end md:justify-items-end">
            ...
            <div className="md:justify-self-start lg:justify-self-center">
              ...
              <ul className="flex flex-col gap-3 text-xs text-slate-400 font-medium">
                ...
                <li>
                  <a href="#technology" onClick={(e) => handleLinkClick(e, 'technology')} className="hover:text-white transition-colors">
                    Models
                  </a>
                </li>
                <li>
                  <a href="#playground" onClick={(e) => handleLinkClick(e, 'home', 'playground')} className="hover:text-white transition-colors">
                    Demo
                  </a>
                </li>
                <li>
                  <a href="mailto:support@imageenhancer.ai" className="hover:text-white transition-colors">
                    Contact
                  </a>
                </li>
              </ul>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500 font-sans">
          ...
          <button 
            onClick={scrollTop} 
            className="hover:text-slate-200 transition-colors flex items-center gap-1 font-mono text-[10px] font-bold tracking-wider uppercase bg-white/5 hover:bg-white/10 border border-white/10 px-3 py-1.5 rounded-lg text-slate-400"
            title="Back to top"
          >
            <span>Top</span>
