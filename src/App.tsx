...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-[#F8FAFC] font-sans antialiased overflow-x-hidden selection:bg-turquoise-500/20 selection:text-turquoise-300">
      ...
      <section id="hero" className="relative pt-20 pb-24 px-4 md:px-8 border-b border-white/5 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
          ...
          >
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-turquoise-400 to-amber-300">
              Pristine 4K Assets
            </span>
          </motion.h1>
